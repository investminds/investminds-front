      ...
      <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-sm">
        ...
        <div className="flex justify-center">
          <LoginButton
            ...
            className="bg-blue-500 text-white font-semibold py-2 px-4 rounded shadow hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-75"
          >
            Login via Facebook
          </LoginButton>
        </div>
