...
const Chatbot = () => {
  ...
  return (
    <div className={`fixed bottom-4 right-4 ${minimized ? 'w-16 h-16' : 'max-w-md w-full'}`}>
      <div className={`bg-[#FF4773] text-white shadow-lg rounded-lg ${minimized ? 'p-2 flex justify-end' : 'p-6'}`}>
        {!minimized ? (
          <>
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-2xl font-bold text-center">Chatbot</h2>
              <button
                className="bg-[#FF4773] text-white py-2 px-4 rounded hover:bg-[#FF003D]"
            ...
            <div className="mb-4">
              <button
                className="bg-white text-[#FF4773] py-2 px-4 rounded hover:bg-[#f7eddd]"
                onClick={sendMessage}
              >
                Enviar
              </button>
          ...
          <button
            className="bg-[#FF4773] text-white py-2 px-4 rounded "
            onClick={toggleMinimize}
          >
            <strong>+</strong>
          </button>
